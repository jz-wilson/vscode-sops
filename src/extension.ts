...
const DEBUG_NAMESPACE = '@jz-wilson/vscode-sops';
...
const getCurrentExtensionName = (context: vscode.ExtensionContext): string => (context.globalState as any)._id ?? 'jz-wilson.vscode-sops';
